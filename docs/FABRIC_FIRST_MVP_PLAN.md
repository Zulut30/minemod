...
| Fabric pack/compiler/fixtures | Pack revision 3 и compiler phase 1 генерируют и строго собирают scaffold, items, blocks, creative entries, shapeless/smelting recipes, models, blockstates, loot, localization, YACL config и Mod Menu entrypoint | Расширить config schema и recipe contract, добавить tags/datagen, GameTests и hosted gates |
